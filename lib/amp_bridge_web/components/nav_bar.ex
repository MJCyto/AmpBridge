defmodule AmpBridgeWeb.NavBar do
  use AmpBridgeWeb, :html
  import AmpBridgeWeb.CoreComponents

  def nav_bar(assigns) do
    if assigns.current_path == "/init" do
      ~H"""
      """
    else
      ~H"""
        ...
        <div class="space-y-1 px-2">
          <.link
            ...
            class={[
              ...
              if(@current_path == "/", do: "bg-teal-600 text-white", else: "text-neutral-300 hover:bg-neutral-700 hover:text-white")
            ]}
          >
            <.icon url="/images/adjustments-vertical.svg" class={"icon w-5 transition-colors duration-300 ease-in-out #{if(@current_path == "/", do: "text-white", else: "text-neutral-300")}"} />
            <span
          ...
          <.link
            ...
            class={[
              "flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ease-in-out ",
              if(@current_path == "/sources", do: "bg-teal-600 text-white", else: "text-neutral-300 hover:bg-neutral-700 hover:text-white")
            ]}
          >
            <.icon url="/images/radio.svg" class={"icon w-5 transition-colors duration-300 ease-in-out #{if(@current_path == "/sources", do: "text-white", else: "text-neutral-300")}"} />
            <span
              class="duration-200 whitespace-nowrap overflow-hidden transition-colors duration-300 ease-in-out"
              x-bind:style="navExpanded ? 'opacity: 1;' : 'opacity: 0;'"
              style="opacity: 0;"
          ...
          <.link
            ...
            class={[
              "flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ease-in-out ",
              if(@current_path == "/zones", do: "bg-teal-600 text-white", else: "text-neutral-300 hover:bg-neutral-700 hover:text-white")
            ]}
          >
            <.icon url="/images/rectangle-group.svg" class={"icon w-5 transition-colors duration-300 ease-in-out #{if(@current_path == "/zones", do: "text-white", else: "text-neutral-300")}"} />
            <span
              class="duration-200 whitespace-nowrap overflow-hidden transition-colors duration-300 ease-in-out"
              x-bind:style="navExpanded ? 'opacity: 1;' : 'opacity: 0;'"
              style="opacity: 0;"
          ...
          <.link
            ...
            class={[
              "flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ease-in-out ",
              if(@current_path == "/serial-config", do: "bg-teal-600 text-white", else: "text-neutral-300 hover:bg-neutral-700 hover:text-white")
            ]}
          >
            <.icon url="/images/cpu-chip.svg" class={"icon w-5 transition-colors duration-300 ease-in-out #{if(@current_path == "/serial-config", do: "text-white", else: "text-neutral-300")}"} />
            <span
              class="duration-200 whitespace-nowrap overflow-hidden transition-colors duration-300 ease-in-out"
              x-bind:style="navExpanded ? 'opacity: 1;' : 'opacity: 0;'"
              style="opacity: 0;"
          ...
          <.link
            navigate={~p"/command-learning"}
            class={[
              "flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ease-in-out ",
              if(@current_path == "/command-learning", do: "bg-teal-600 text-white", else: "text-neutral-300 hover:bg-neutral-700 hover:text-white")
            ]}
          >
            <.icon url="/images/book-open.svg" class={"icon w-5 transition-colors duration-300 ease-in-out #{if(@current_path == "/command-learning", do: "text-white", else: "text-neutral-300")}"} />
            <span
              class="duration-200 whitespace-nowrap overflow-hidden transition-colors duration-300 ease-in-out"
              x-bind:style="navExpanded ? 'opacity: 1;' : 'opacity: 0;'"
              style="opacity: 0;"
            >Command Learning</span>
          </.link>
        </div>
      </div>
      ...
      <div class="p-4 border-t border-neutral-700">
        <div
          class="text-xs text-neutral-500 text-center duration-200 overflow-hidden"
          x-show="navExpanded"
          x-transition
          x-bind:style="navExpanded ? 'opacity: 1;' : 'opacity: 0;'"
          style="opacity: 0;"
